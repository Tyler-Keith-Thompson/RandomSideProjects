...
final class EmailValidationTests: XCTestCase {
    ...
    func testInvalidEmails() {
        ...
        XCTAssertThrowsError(try Email("(onlycomment).local-starts-with-dot@sld.com"))
    ...
    func testSemanticAddressCanBeExtractedAfterParsing() {
        XCTAssertEqual(try Email("user@example.com").semantic.address, "user@example.com")
        XCTAssertEqual(try Email("!#$%&'*+-/=?^_`{|}~@example.com").semantic.address, "!#$%&'*+-/=?^_`{|}~@example.com")
        XCTAssertEqual(try Email("user.name+tag@example.com").semantic.address, "user.name+tag@example.com")
        XCTAssertEqual(try Email("\"user name\\@tag \\\"falseQuote\"@example.com").semantic.address, "\"user name\\@tag \\\"falseQuote\"@example.com")
        XCTAssertEqual(try Email("()empty.comment@example.com").semantic.address, "empty.comment@example.com")
        XCTAssertEqual(try Email("(this is a comment)me@example.com").semantic.address, "me@example.com")
        XCTAssertEqual(try Email("(this is a (nested comment))me@example.com").semantic.address, "me@example.com")
        XCTAssertEqual(try Email("(this is <a> comment)me@example.com").semantic.address, "me@example.com")
        XCTAssertEqual(try Email("me(this is a comment)@example.com").semantic.address, "me@example.com")
        XCTAssertEqual(try Email("(this is a comment)me(another)@example.com").semantic.address, "me@example.com")
        XCTAssertEqual(try Email("me(this is a (nested comment))@example.com").semantic.address, "me@example.com")
        XCTAssertEqual(try Email("me(this is <a> comment)@example.com").semantic.address, "me@example.com")
        XCTAssertEqual(try Email("309d4696df38ff12c023600e3bc2bd4b@fakedomain.com").semantic.address, "309d4696df38ff12c023600e3bc2bd4b@fakedomain.com")
        XCTAssertEqual(try Email("ewiuhdghiufduhdvjhbajbkerwukhgjhvxbhvbsejskuadukfhgskjebf@gmail.net").semantic.address, "ewiuhdghiufduhdvjhbajbkerwukhgjhvxbhvbsejskuadukfhgskjebf@gmail.net")
        XCTAssertEqual(try Email("John Doe <john.doe@example.com>").semantic.address, "john.doe@example.com")
        XCTAssertEqual(try Email("\"John Doe\" <john.doe@example.com>").semantic.address, "john.doe@example.com")
        XCTAssertEqual(try Email("John Doe (this is <a> comment) <john.doe@example.com>").semantic.address, "john.doe@example.com")
        XCTAssertEqual(try Email("用户@example.com").semantic.address, "用户@example.com")
        XCTAssertEqual(try Email("H.B. Lewis <test@earthlink.net>").semantic.address, "test@earthlink.net")
        XCTAssertEqual(try Email("(comments)andwhitespace .in. \r\n local \r\n@example.com").semantic.address, "andwhitespace.in.local@example.com")
        XCTAssertEqual(try Email("\r\n whitespace.before.and.after.local \r\n@example.com").semantic.address, "whitespace.before.and.after.local@example.com")
        XCTAssertEqual(try Email("(comments)\r\n\" andwhitespace \"@example.org").semantic.address, "\" andwhitespace \"@example.org")
        XCTAssertEqual(try Email("(comments)\r\n\" andwhitespace \" (even after)\r\n@example.org").semantic.address, "\" andwhitespace \"@example.org")

        XCTAssertEqual(try Email("user@example.com").semantic.address, "user@example.com")
        XCTAssertEqual(try Email("用户@例子.测试").semantic.address, "用户@例子.测试")
        XCTAssertEqual(try Email("user@subdomain(comment).example.com").semantic.address, "user@subdomain.example.com")
        XCTAssertEqual(try Email("user@(comment)subdomain.example.com").semantic.address, "user@subdomain.example.com")
        XCTAssertEqual(try Email("user@subdomain.(comment)example.com").semantic.address, "user@subdomain.example.com")
        XCTAssertEqual(try Email("user@subdomain.example(comment).com").semantic.address, "user@subdomain.example.com")
        XCTAssertEqual(try Email("user@subdomain.example.com").semantic.address, "user@subdomain.example.com")
        XCTAssertEqual(try Email("user@sub-domain.example.com").semantic.address, "user@sub-domain.example.com")
        XCTAssertEqual(try Email("me.example@com").semantic.address, "me.example@com")
        XCTAssertEqual(try Email("user@[123.123.123.123]").semantic.address, "user@[123.123.123.123]")
        XCTAssertEqual(try Email("user@[127.000.000.001]").semantic.address, "user@[127.0.0.1]")
        XCTAssertEqual(try Email("user@[IPv6:2001:db8::1]").semantic.address, "user@[IPv6:2001:DB8::1]")
        XCTAssertEqual(try Email("user@[IPv6:0000:0000:0000:0000:0000:0000:0000:0001]").semantic.address, "user@[IPv6:::1]")
        XCTAssertEqual(try Email("user@[IPv6:0123:4567:89AB:CDEF:0123:4567:89AB:CDEF]").semantic.address, "user@[IPv6:123:4567:89AB:CDEF:123:4567:89AB:CDEF]")

        XCTAssertEqual(try Email("\"Abc\\@def\"@example.com").semantic.address, "\"Abc\\@def\"@example.com")
        XCTAssertEqual(try Email("\"Fred Bloggs\"@example.com").semantic.address, "\"Fred Bloggs\"@example.com")
        XCTAssertEqual(try Email("\"Joe\\\\Blow\"@example.com").semantic.address, "\"Joe\\\\Blow\"@example.com")
        XCTAssertEqual(try Email("\"Abc@def\"@example.com").semantic.address, "\"Abc@def\"@example.com")
        XCTAssertEqual(try Email("customer/department=shipping@example.com").semantic.address, "customer/department=shipping@example.com")
        XCTAssertEqual(try Email("$A12345@example.com").semantic.address, "$A12345@example.com")
        XCTAssertEqual(try Email("!def!xyz%abc@example.com").semantic.address, "!def!xyz%abc@example.com")
        XCTAssertEqual(try Email("_somename@example.com").semantic.address, "_somename@example.com")
        XCTAssertEqual(try Email("valid.ipv4.addr@[123.1.72.10]").semantic.address, "valid.ipv4.addr@[123.1.72.10]")
        XCTAssertEqual(try Email("valid.ipv6.addr@[IPv6:0::1]").semantic.address, "valid.ipv6.addr@[IPv6:::1]")
        XCTAssertEqual(try Email("valid.ipv6.addr@[IPv6:2607:f0d0:1002:51::4]").semantic.address, "valid.ipv6.addr@[IPv6:2607:F0D0:1002:51::4]")
        XCTAssertEqual(try Email("valid.ipv6.addr@[IPv6:fe80::230:48ff:fe33:bc33]").semantic.address, "valid.ipv6.addr@[IPv6:FE80::230:48FF:FE33:BC33]")
        XCTAssertEqual(try Email("valid.ipv6.addr@[IPv6:fe80:0000:0000:0000:0202:b3ff:fe1e:8329]").semantic.address, "valid.ipv6.addr@[IPv6:FE80::202:B3FF:FE1E:8329]")

        XCTAssertEqual(try Email("niceandsimple@example.com").semantic.address, "niceandsimple@example.com")
        XCTAssertEqual(try Email("very.common@example.com").semantic.address, "very.common@example.com")
        XCTAssertEqual(try Email("a.little.lengthy.but.fine@dept.example.com").semantic.address, "a.little.lengthy.but.fine@dept.example.com")
        XCTAssertEqual(try Email("disposable.style.email.with+symbol@example.com").semantic.address, "disposable.style.email.with+symbol@example.com")
        XCTAssertEqual(try Email("user@[IPv6:2001:db8:1ff::a0b:dbd0]").semantic.address, "user@[IPv6:2001:DB8:1FF::A0B:DBD0]")
        XCTAssertEqual(try Email("\"much.more unusual\"@example.com").semantic.address, "\"much.more unusual\"@example.com")
        XCTAssertEqual(try Email("\"very.unusual.@.unusual.com\"@example.com").semantic.address, "\"very.unusual.@.unusual.com\"@example.com")
        XCTAssertEqual(try Email("\"very.())):;<>[]\\\".VERY.\\\"very@\\\\ \\\"very\\\".unusual\"@strange.example.com").semantic.address, "\"very.())):;<>[]\\\".VERY.\\\"very@\\\\ \\\"very\\\".unusual\"@strange.example.com")
        XCTAssertEqual(try Email("postbox@com").semantic.address, "postbox@com")
        XCTAssertEqual(try Email("admin@mailserver1").semantic.address, "admin@mailserver1")
        XCTAssertEqual(try Email("!#$%&'*+-/=?^_`{}|~@example.org").semantic.address, "!#$%&'*+-/=?^_`{}|~@example.org")
        XCTAssertEqual(try Email("\"()<>[]:));@\\\\\\\"!#$%&'*+-/=?^_`{}| ~.a\"@example.org").semantic.address, "\"()<>[]:));@\\\\\\\"!#$%&'*+-/=?^_`{}| ~.a\"@example.org")
        XCTAssertEqual(try Email("\" \"@example.org").semantic.address, "\" \"@example.org")

        XCTAssertEqual(try Email("\"\\e\\s\\c\\a\\p\\e\\d\"@sld.com").semantic.address, "\"\\e\\s\\c\\a\\p\\e\\d\"@sld.com")
        XCTAssertEqual(try Email("\"back\\slash\"@sld.com").semantic.address, "\"back\\slash\"@sld.com")
        XCTAssertEqual(try Email("\"escaped\\\"quote\"@sld.com").semantic.address, "\"escaped\\\"quote\"@sld.com")
        XCTAssertEqual(try Email("\"quoted\"@sld.com").semantic.address, "\"quoted\"@sld.com")
        XCTAssertEqual(try Email("\"quoted-at-sign@sld.org\"@sld.com").semantic.address, "\"quoted-at-sign@sld.org\"@sld.com")
        XCTAssertEqual(try Email("&'*+-./=?^_{}~@other-valid-characters-in-local.net").semantic.address, "&'*+-./=?^_{}~@other-valid-characters-in-local.net")
        XCTAssertEqual(try Email("01234567890@numbers-in-local.net").semantic.address, "01234567890@numbers-in-local.net")
        XCTAssertEqual(try Email("a@single-character-in-local.org").semantic.address, "a@single-character-in-local.org")
        XCTAssertEqual(try Email("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@letters-in-local.org").semantic.address, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@letters-in-local.org")
        XCTAssertEqual(try Email("backticksarelegit@test.com").semantic.address, "backticksarelegit@test.com")
        XCTAssertEqual(try Email("bracketed-IP-instead-of-domain@[127.0.0.1]").semantic.address, "bracketed-IP-instead-of-domain@[127.0.0.1]")
        XCTAssertEqual(try Email("country-code-tld@sld.rw").semantic.address, "country-code-tld@sld.rw")
        XCTAssertEqual(try Email("country-code-tld@sld.uk").semantic.address, "country-code-tld@sld.uk")
        XCTAssertEqual(try Email("letters-in-sld@123.com").semantic.address, "letters-in-sld@123.com")
        XCTAssertEqual(try Email("local@dash-in-sld.com").semantic.address, "local@dash-in-sld.com")
        XCTAssertEqual(try Email("local@sld.newTLD").semantic.address, "local@sld.newTLD")
        XCTAssertEqual(try Email("local@sub.domains.com").semantic.address, "local@sub.domains.com")
        XCTAssertEqual(try Email("mixed-1234-in-{+^}-local@sld.net").semantic.address, "mixed-1234-in-{+^}-local@sld.net")
        XCTAssertEqual(try Email("one-character-third-level@a.example.com").semantic.address, "one-character-third-level@a.example.com")
        XCTAssertEqual(try Email("one-letter-sld@x.org").semantic.address, "one-letter-sld@x.org")
        XCTAssertEqual(try Email("punycode-numbers-in-tld@sld.xn--3e0b707e").semantic.address, "punycode-numbers-in-tld@sld.xn--3e0b707e")
        XCTAssertEqual(try Email("single-character-in-sld@x.org").semantic.address, "single-character-in-sld@x.org")
        XCTAssertEqual(try Email("the-character-limit@for-each-part.of-the-domain.is-sixty-three-characters.this-is-exactly-sixty-three-characters-so-it-is-valid-blah-blah.com").semantic.address, "the-character-limit@for-each-part.of-the-domain.is-sixty-three-characters.this-is-exactly-sixty-three-characters-so-it-is-valid-blah-blah.com")
        XCTAssertEqual(try Email("the-total-length@of-an-entire-address.cannot-be-longer-than-two-hundred-and-fifty-four-characters.and-this-address-is-254-characters-exactly.so-it-should-be-valid.and-im-going-to-add-some-more-words-here.to-increase-the-length-blah-blah-blah-blah-bla.org").semantic.address, "the-total-length@of-an-entire-address.cannot-be-longer-than-two-hundred-and-fifty-four-characters.and-this-address-is-254-characters-exactly.so-it-should-be-valid.and-im-going-to-add-some-more-words-here.to-increase-the-length-blah-blah-blah-blah-bla.org")
        XCTAssertEqual(try Email("uncommon-tld@sld.mobi").semantic.address, "uncommon-tld@sld.mobi")
        XCTAssertEqual(try Email("uncommon-tld@sld.museum").semantic.address, "uncommon-tld@sld.museum")
        XCTAssertEqual(try Email("uncommon-tld@sld.travel").semantic.address, "uncommon-tld@sld.travel")

        XCTAssertEqual(try Email("Pelé@example.com").semantic.address, "Pelé@example.com") // Latin with diacritics
        XCTAssertEqual(try Email("伊昭傑@郵件.商務").semantic.address, "伊昭傑@郵件.商務") // Chinese
        XCTAssertEqual(try Email("राम@मोहन.ईन्फो").semantic.address, "राम@मोहन.ईन्फो") // Hindi
        XCTAssertEqual(try Email("юзер@екзампл.ком").semantic.address, "юзер@екзампл.ком") // Ukranian
        XCTAssertEqual(try Email("θσερ@εχαμπλε.ψομ").semantic.address, "θσερ@εχαμπλε.ψομ") // Greek
        XCTAssertEqual(try Email("дядя_вася@деревня.рф").semantic.address, "дядя_вася@деревня.рф") // Russian
    }
}
